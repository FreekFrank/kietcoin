...
LITECOIND=${LITECOIND:-$SRCDIR/kietcoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/kietcoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/kietcoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/kietcoin-qt}
