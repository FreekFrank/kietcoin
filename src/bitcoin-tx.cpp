...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kietcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kietcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kietcoin transaction") + "\n" +
              "  kietcoin-tx [options] -create [commands]   " + _("Create hex-encoded kietcoin transaction") + "\n" +
              "\n";
