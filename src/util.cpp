...
const char * const BITCOIN_CONF_FILENAME = "kietcoin.conf";
const char * const BITCOIN_PID_FILENAME = "kietcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kietcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Kietcoin";
#else
    // Unix
    return pathRet / ".kietcoin";
#endif
#endif
}
