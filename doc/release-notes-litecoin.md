Kietcoin Core version *0.15.1* is now available from:

  <https://download.kietcoin.org/kietcoin-0.15.1/>
...
A number of changes to the way Kietcoin Core deals with peer connections and invalid blocks
